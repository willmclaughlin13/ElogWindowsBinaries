...
Section "ELOG system (required)" SecSystem
  ...
  File x64\release\elogd.exe
  File x64\release\elog.exe
  File x64\release\elconv.exe
  #File \windows\system32\libeay32.dll
  #File \windows\system32\ssleay32.dll
  File x64\release\\msvcr90.dll
  File x64\release\\msvcr100.dll
  File x64\release\\msvcr110.dll
